...
Features:
📅 Cycle calendar with period, fertile window, ovulation and PMS predictions
🩸 Flow tracking with visual blood drop intensity selector
😊 Mood and symptom logging
🌙 Real moon phase displayed on every calendar date
✨ AI-powered daily lunar, astronomy and tarot readings
📊 Cycle stats and health insights
🔒 100% private — all data lives on your device only
📲 Installable as a PWA — works offline, no app store needed
